...
<button class="timesheetButton" onclick="timesheetProject()" style="padding: 17px 22px; font-family: Luckiest Guy; font-size: 22px">
Timesheet</button>
...
<div id="timesheet" style="display: none">
    ...
    <div style="margin-left: 10px; margin-right: 10px; padding-left: 30px; padding-right: 30px; padding-top: 10px; padding-bottom: 10px; background-color: rgba(167, 182, 152, 0.08); border-radius: 30px; color: rgb(210, 190, 170)">
        <p style="font-size: 18px; font-family: candara; color: rgba(199, 224, 199, 0.85)">
        ...
        <h5 style="padding-bottom: 0px; text-align: left; color: rgba(114, 255, 122, 0.85); margin-left: 10px; font-family: candara">Input sheet functions</h5>
        ...
        <h5 style="padding-bottom: 0px; text-align: left; color: rgba(114, 255, 122, 0.84); margin-left: 10px; font-family: candara">Navigation buttons</h5>
        ...
        <h5 style="padding-bottom: 0px; text-align: left; color: rgba(114, 255, 122, 0.84); margin-left: 10px; font-family: candara">Update hours</h5>
