...
<div style="margin-left: 10px; margin-right: 10px; padding-left: 30px; padding-right: 30px; padding-top: 10px; padding-bottom: 10px; background-color: rgba(182, 169, 152, 0.15); border-radius: 30px; color: rgb(210, 190, 170)">
    ...
    To see a functional version, you will need to follow the link below and make a copy of the spreadsheet and then refresh the page and then a new button should appear to the right of "Help" labeled "JORDAN". 
    ...
    <!-- <div class="row" style="width: 100%">
        <div class="column" style="width: 50%">
            <a href="https://docs.google.com/spreadsheets/d/1KLvtX0E5XLsJzfkO9iCKFv_QAl3xg28GB7cfPIQF7Co/edit?usp=sharing" target="_blank">
                <img src="https://raw.githubusercontent.com/jAdelaide/Portfolio/shove/assets/Timesheet.png" alt="Screenshot of the timesheet" title="Open the timesheet in a new tab" height="auto" width="50%" style="margin-left: 50%;">
            </a>
        </div>
        <div class="column" style="width: 50%; margin-left: 50%">
            <a href="https://docs.google.com/spreadsheets/d/1KLvtX0E5XLsJzfkO9iCKFv_QAl3xg28GB7cfPIQF7Co/edit?usp=sharing" target="_blank">
                <img src="https://raw.githubusercontent.com/jAdelaide/Portfolio/shove/assets/Timesheet_dropdown.png" alt="Screenshot of the timesheet with the custom menu open" title="Open the timesheet in a new tab" height="auto" width="50%" style="margin-left: 50%;">
            </a>
        </div>
    </div> -->

    <a href="https://docs.google.com/spreadsheets/d/1KLvtX0E5XLsJzfkO9iCKFv_QAl3xg28GB7cfPIQF7Co/edit?usp=sharing" target="_blank">
        <img src="https://raw.githubusercontent.com/jAdelaide/Portfolio/shove/assets/Timesheet_joined.png" alt="Screenshot of the timesheet" title="Open the timesheet in a new tab" height="auto" width="100%">
    </a>
    <br><br>
