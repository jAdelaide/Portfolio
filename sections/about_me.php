...
<div style="z-index: 1; position: absolute">
    <form style="padding-top: 0px; padding-left: 980px">
        <img src="https://raw.githubusercontent.com/jAdelaide/Portfolio/shove/assets/jordanGlitchBackground.png" height="300px" title="The code for the languages homepage section" alt="A 'foreach' and 'if' nested loop that cycles through each language to include in the section">
    </form>
</div>
</div>